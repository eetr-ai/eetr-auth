...
- **Setup** area (`Dashboard → Setup`) — a tabbed page covering **Site identity** (title, logo, URL, CDN URL), **Admin API**, **Environments**, **Scopes**, and **Password policies** (per-environment complexity rules + max password age).
